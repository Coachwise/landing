...
session:
  ...
  meta: "3 sets · 2 done"
  rows:
    - { set: "Set 1", detail: "8 reps · 12 kg", done: true }
    - { set: "Set 2", detail: "8 reps · 12 kg", done: true }
    - { set: "Set 3", detail: "6 reps · 14 kg", done: false }
  timer: "24:10"
...
coach:
  ...
  body: "Build plans, sell packages, and see every client on one screen. What an athlete pays lands in your wallet, and you cash out when you want to."
  points:
    - "One plan builder for barbell and wall"
...
cta:
  ...
  body: "The app is in beta. The buttons below go live the moment the store listings do."

footer:
  tagline: "Strength training and climbing, in one app."
  beta: "Beta"
---
